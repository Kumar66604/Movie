...
async def pm_next_page(bot, query):
    ...
    btn.insert(0, [InlineKeyboardButton("🔗 ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ 🔗", "https://t.me/+g06yDNtGBD1jM2Y9")])
...
async def pm_AutoFilter(client, msg, pmspoll=False):    
    ...
    btn.insert(0, [InlineKeyboardButton("🔗 ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ 🔗", "https://t.me/+vknr1PnklSQyNGI9")])
    if offset != "":
        key = f"{message.id}"
